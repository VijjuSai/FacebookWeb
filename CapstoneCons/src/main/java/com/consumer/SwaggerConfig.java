...
public class SwaggerConfig {
    ...
    public Docket api1() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName("testing")
                .select()
	...
	private ApiInfo apiInfo() {
    	return new ApiInfoBuilder().title("My Swagger Title")
    			.description("Giving custom information")
    			.termsOfServiceUrl("http://www.mygreatlearning.com")
    			.version("1.0.2")
    			.build();
    }
